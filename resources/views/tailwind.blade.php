...
<body class="bg-gray-100 font-sans">
    ...
    <div class="flex p-6 gap-6">
        ...
        <aside class="w-1/3 bg-white shadow p-4 rounded-lg">
            ...
            <!-- Formulario -->
            <form class="space-y-4" action='{{route("article.create")}}' method="post">
                @csrf
                <div>
                    <label class="block text-sm font-medium text-gray-700">Nombre artículo</label>
                    <input type="text" class="w-full border rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" id="nombre_art" name="nombre_art">
                </div>

                <div>
                    <label class="block text-sm font-medium text-gray-700">Precio</label>
                    <input type="number" class="w-full border rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" id="precio_art" name="precio_art">
                </div>
                ...
                <tbody>
                    <tr>
                        ...
                        <tr class="border-b">
                            ...
                            <td>
                                <button class="bg-blue-500 text-white px-1 py-1 rounded" command="show-modal" commandfor="dialog">Editar</button>
                                <button class="bg-red-500 text-white px-1 py-1 rounded">Borrar</button>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
